# -*- coding: utf-8 -*-
#
# Gerritlib documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../..'))
sys.path.insert(0, os.path.abspath('../../gerritlib'))
...
htmlhelp_basename = 'Gerritlibdoc'
...
latex_documents = [
    ('index', 'Gerritlib.tex', u'Gerritlib Documentation',
     u'Openstack Infra', 'manual'),
]
